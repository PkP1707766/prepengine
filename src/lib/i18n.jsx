...
Object.assign(STR, {
  ...
  band2_a:  { en: "Not the brilliant. The ", hi: "तेज़ दिमाग़ नहीं, " },
  band2_em: { en: "relentless", hi: "डटे रहने वाला" },
  band2_b:  { en: ".", hi: " जीतता है।" },
  band2_l:  { en: "The rank goes to whoever kept coming back to the desk — one real test, one honest review, again tomorrow.",
              hi: "रैंक उसी की होती है जो रोज़ मेज़ पर लौटता रहा — एक असली टेस्ट, एक ईमानदार समीक्षा, और कल फिर वही।" },
  ...
  band4_a:  { en: "Big scores aren't a spark. They're a ", hi: "बड़े नंबर चमक से नहीं, " },
  band4_em: { en: "habit", hi: "आदत" },
  band4_b:  { en: ".", hi: " से बनते हैं।" },
  band4_l:  { en: "Built one ordinary evening at a time — a paper, its honest report, and a reason to sit down again tomorrow.",
              hi: "एक-एक मामूली शाम से — एक पेपर, उसकी ईमानदार रिपोर्ट, और कल फिर बैठने की एक वजह।" },
...
Object.assign(STR, {
  ...
  ex_notvisited:  { en: "Not Visited", hi: "अभी नहीं देखा" },
  ex_marked:      { en: "Marked for Review", hi: "समीक्षा के लिए मार्क" },
  ex_ansmarked:   { en: "Answered & Marked", hi: "उत्तर दिया, मार्क भी" },
  ...
  ex_mark_next:   { en: "Mark for Review & Next", hi: "मार्क करें और आगे" },
  ...
  ex_in_progress: { en: "Attempt in progress", hi: "टेस्ट चल रहा है" },
  ...
  ex_assertion:   { en: "Assertion (A)", hi: "अभिकथन (A)" },
  ...
  ex_format_eyebrow: { en: "Format literacy", hi: "प्रारूप दक्षता" },
  ex_by_format:   { en: "Difficulty & format", hi: "कठिनाई एवं प्रारूप" },
  ex_by_format_sub: { en: "Is the gap in a topic, or in a question format?", hi: "कमी किसी विषय में है या प्रश्न-प्रारूप में?" },
  ex_by_difficulty: { en: "By difficulty", hi: "कठिनाई अनुसार" },
  ex_by_type:     { en: "By question type", hi: "प्रश्न-प्रकार अनुसार" },
  ex_diff_easy:   { en: "Easy", hi: "आसान" },
  ex_diff_medium: { en: "Medium", hi: "मध्यम" },
  ex_diff_hard:   { en: "Hard", hi: "कठिन" },
  ex_trend_title: { en: "How this fits your trend", hi: "यह आपकी प्रगति में कैसे बैठता है" },
  ex_ansmarked_l: { en: "Answered & Marked for Review", hi: "उत्तर दिया, समीक्षा के लिए मार्क भी" },
...
Object.assign(STR, {
  ...
  sd_view_sol:    { en: "View solutions", hi: "समाधान देखें" },
  sd_hide_sol:    { en: "Hide solutions", hi: "समाधान छिपाएँ" },
  sd_mistakes:    { en: "your mistakes", hi: "आपकी गलतियाँ" },
  sd_loading:     { en: "Loading…", hi: "लोड हो रहा है…" },
  sd_no_mistakes: { en: "No mistakes here", hi: "यहाँ कोई गलती नहीं" },
  sd_no_mistakes_sub: { en: "You haven't got a question wrong in this subject yet.", hi: "आपने अभी तक इस विषय में कोई प्रश्न गलत नहीं किया है।" },
  sd_tap_subject: { en: "Tap a subject to review the questions you missed across all attempts.", hi: "सभी प्रयासों में छूटे प्रश्नों की समीक्षा हेतु किसी विषय पर टैप करें।" },
  ...
  sd_tab_avail:    { en: "Available ({n})", hi: "उपलब्ध ({n})" },
  sd_tab_upcoming: { en: "Upcoming ({n})", hi: "आने वाले ({n})" },
  sd_tab_attempted:{ en: "Attempted ({n})", hi: "दिए हुए ({n})" },
  sd_done:         { en: "Done", hi: "हो गया" },
  sd_open:         { en: "Open", hi: "खोलिए" },
  sd_valid_till:   { en: "Valid till {d}", hi: "{d} तक मान्य" },
  sd_valid_till_l: { en: "valid till {d}", hi: "{d} तक मान्य" },
  sd_lifetime:     { en: "Lifetime", hi: "आजीवन" },
  sd_lifetime_l:   { en: "lifetime access", hi: "आजीवन एक्सेस" },
  sd_days_left:    { en: "{n}d left", hi: "{n} दिन बाक़ी" },
  sd_tests_done:   { en: "{a} of {b} tests done", hi: "{b} में से {a} टेस्ट हो गए" },
  sd_every_attempt:{ en: "Every attempt since you started — the trend is what matters, not any single test.",
                     hi: "शुरुआत से हर प्रयास — मायने रुझान रखता है, कोई एक टेस्ट नहीं।" },
  sd_avg_vs_all:   { en: "Average score % against everyone who has taken the same tests.",
                     hi: "वही टेस्ट देने वाले सबके मुक़ाबले आपका औसत स्कोर %।" },
  sd_cmp_locked:   { en: "Comparison unlocks once other aspirants attempt the same tests.",
                     hi: "जब दूसरे अभ्यर्थी आपके टेस्ट देंगे, तब तुलना खुलेगी।" },
  sd_batch_avg:    { en: "Batch avg", hi: "बैच औसत" },
  sd_topper:       { en: "Topper", hi: "टॉपर" },
  sd_you:          { en: "You", hi: "आप" },
  sd_overall:      { en: "overall", hi: "कुल मिलाकर" },
  sd_avg_score_l:  { en: "avg score", hi: "औसत स्कोर" },
  sd_podium:       { en: "You're on the podium!", hi: "आप मंच पर हैं!" },
  sd_top10:        { en: "You're in the top 10!", hi: "आप टॉप 10 में हैं!" },
  sd_keep_climb:   { en: "Keep climbing", hi: "चढ़ते रहिए" },
  sd_joined_on:    { en: "Joined {d}", hi: "{d} को जुड़े" },
  sd_mat_all:      { en: "All", hi: "सभी" },
  sd_type_pdf:     { en: "PDF", hi: "PDF" },
  sd_type_note:    { en: "NOTE", hi: "नोट्स" },
  sd_type_video:   { en: "VIDEO", hi: "वीडियो" },
  sd_type_link:    { en: "LINK", hi: "लिंक" },
  sd_no_mat_q:     { en: "No material found matching \"{q}\".", hi: "\"{q}\" से मिलती कोई सामग्री नहीं मिली।" },
  sd_no_mat_f:     { en: "No material found in {f}.", hi: "{f} में कोई सामग्री नहीं मिली।" },
  sd_all_exams:    { en: "All exams", hi: "सभी परीक्षाएँ" },
  sd_rank_line:    { en: "Rank #{r} of {n} · top {p}% · {c} tests taken", hi: "{n} में से रैंक #{r} · टॉप {p}% · {c} टेस्ट दिए" },
  sd_tests_acc:    { en: "{n} tests · {a}% accuracy", hi: "{n} टेस्ट · {a}% सटीकता" },
  sd_no_tests_yet: { en: "No tests published yet.", hi: "अभी कोई टेस्ट नहीं आया है।" },
  sd_all_attempted:{ en: "You've attempted every published test. New ones land here.", hi: "जो भी टेस्ट आए हैं, आप सब दे चुके हैं। नए यहीं दिखेंगे।" },
  sd_less:         { en: "Less", hi: "कम" },
  sd_more:         { en: "More", hi: "ज़्यादा" },
  sd_since:        { en: "Since {d}", hi: "{d} से" },
  sd_day:          { en: "day", hi: "दिन" },
  sd_days:         { en: "days", hi: "दिन" },
  sd_in_test:      { en: "in {x}", hi: "{x} में" },
  sd_ranked_once:  { en: "ranked once others attempt", hi: "दूसरों के देने पर रैंक बनेगी" },
  sd_no_activity:  { en: "no activity", hi: "कोई गतिविधि नहीं" },
  sd_n_tests:      { en: "{n} tests", hi: "{n} टेस्ट" },
  sd_standalone:   { en: "Standalone test", hi: "अलग टेस्ट" },

  /* --- dashboard: the greeting, the quotes and the stat sub-labels --- */
  sd_morning:      { en: "Good morning", hi: "सुप्रभात" },
  sd_afternoon:    { en: "Good afternoon", hi: "नमस्कार" },
  sd_evening:      { en: "Good evening", hi: "शुभ संध्या" },
  sd_aspirant:     { en: "Aspirant", hi: "अभ्यर्थी" },
  sd_q1: { en: "Consistency beats intensity. Show up today.", hi: "तेज़ी से ज़्यादा नियमितता काम आती है। आज बैठिए।" },
  sd_q2: { en: "Every mock is a rehearsal for the real day.", hi: "हर मॉक असली दिन की रिहर्सल है।" },
  sd_q3: { en: "Small daily progress compounds into ranks.", hi: "रोज़ की छोटी प्रगति ही रैंक बनती है।" },
  sd_q4: { en: "Revise what you learn, or you'll relearn what you forgot.", hi: "जो पढ़ा है उसे दोहराइए, वरना भूला हुआ फिर से पढ़ना पड़ेगा।" },
  sd_q5: { en: "Discipline today, designation tomorrow.", hi: "आज अनुशासन, कल पद।" },
  sd_days_target: { en: "days to your target", hi: "दिन बाक़ी हैं लक्ष्य में" },
  sd_days_to:     { en: "{n} days to {x}", hi: "{x} में {n} दिन बाक़ी" },
  sd_just_start:  { en: "just getting started", hi: "अभी शुरुआत है" },
  sd_keep_going:  { en: "keep going", hi: "लगे रहिए" },
  sd_across_all:  { en: "across all attempts", hi: "सभी प्रयासों में" },
  sd_vs_last:     { en: "vs last test", hi: "पिछले टेस्ट के मुक़ाबले" },
  sd_practise_today: { en: "practise today to start one", hi: "आज अभ्यास कीजिए, सिलसिला शुरू हो" },
  sd_active_days: { en: "active days total", hi: "कुल सक्रिय दिन" },
  sd_best_n:      { en: "best", hi: "सर्वश्रेष्ठ" },
  sd_streak_days: { en: "{n}-day streak", hi: "{n} दिन लगातार" },
  sd_start_chain: { en: "Take a test today to start one.", hi: "आज एक टेस्ट दीजिए, सिलसिला शुरू कीजिए।" },
  sd_keep_chain:  { en: "Don't break the chain — practise today!", hi: "सिलसिला मत तोड़िए — आज अभ्यास कीजिए!" },
  sd_accuracy_of: { en: "{n}% accuracy", hi: "{n}% सटीकता" },

  /* --- dashboard: everything that was still sitting in the JSX in English.
     A Hindi sidebar around English panels was the whole complaint. --- */
  sd_secwise:      { en: "Section-wise", hi: "सेक्शन-वार" },
  sd_nosec:        { en: "No section breakdown was recorded for this attempt.", hi: "इस प्रयास का सेक्शन-वार ब्योरा दर्ज नहीं हुआ।" },
  sd_revise_first: { en: "Revise first", hi: "पहले यह दोहराइए" },
  sd_reattempt:    { en: "Re-attempt", hi: "दोबारा दीजिए" },
  sd_first_mock:   { en: "Your first mock is waiting", hi: "आपका पहला मॉक इंतज़ार में है" },
  sd_tests_att:    { en: "Tests attempted", hi: "दिए गए टेस्ट" },
  sd_avg_score:    { en: "Average score", hi: "औसत स्कोर" },
  sd_best_pct:     { en: "Best percentile", hi: "सर्वश्रेष्ठ पर्सेंटाइल" },
  sd_streak_l:     { en: "Study streak", hi: "लगातार पढ़ाई" },
  sd_trajectory:   { en: "Your trajectory", hi: "आपकी दिशा" },
  sd_trend_l:      { en: "Score & percentile trend", hi: "स्कोर और पर्सेंटाइल की चाल" },
  sd_view_full:    { en: "View full analysis", hi: "पूरा विश्लेषण देखिए" },
  sd_pickup:       { en: "Pick up where you left", hi: "जहाँ छोड़ा था, वहीं से" },
  sd_start:        { en: "Start", hi: "शुरू कीजिए" },
  sd_str_focus:    { en: "Strengths & focus", hi: "मज़बूती और ध्यान" },
  sd_where_stand:  { en: "Where you stand", hi: "आप कहाँ खड़े हैं" },
  sd_strongest:    { en: "Strongest", hi: "सबसे मज़बूत" },
  sd_needs_work:   { en: "Needs work", hi: "मेहनत चाहिए" },
  sd_last12:       { en: "Last 12 weeks", hi: "पिछले 12 हफ़्ते" },
  sd_activity:     { en: "Study activity", hi: "पढ़ाई की गतिविधि" },
  sd_your_access:  { en: "Your access", hi: "आपका एक्सेस" },
  sd_search_tests: { en: "Search tests…", hi: "टेस्ट खोजिए…" },
  sd_sort_recent:  { en: "Sort: Most recent", hi: "क्रम: सबसे नए" },
  sd_sort_score:   { en: "Sort: Highest score", hi: "क्रम: सबसे ज़्यादा स्कोर" },
  sd_sort_rank:    { en: "Sort: Best rank", hi: "क्रम: सर्वश्रेष्ठ रैंक" },
  sd_start_test:   { en: "Start test", hi: "टेस्ट शुरू कीजिए" },
  sd_rem_set:      { en: "Reminder set", hi: "रिमाइंडर लगा है" },
  sd_set_rem:      { en: "Set reminder", hi: "रिमाइंडर लगाइए" },
  sd_score:        { en: "Score", hi: "स्कोर" },
  sd_view_anal:    { en: "View analysis", hi: "विश्लेषण देखिए" },
  sd_no_anal:      { en: "No analytics yet", hi: "अभी कोई विश्लेषण नहीं" },
  sd_tests_taken:  { en: "Tests taken", hi: "दिए गए टेस्ट" },
  sd_avg_score_s:  { en: "Avg score", hi: "औसत स्कोर" },
  sd_avg_acc:      { en: "Avg accuracy", hi: "औसत सटीकता" },
  sd_total_time:   { en: "Total time", hi: "कुल समय" },
  sd_trend_time:   { en: "Score & percentile over time", hi: "समय के साथ स्कोर और पर्सेंटाइल" },
  sd_diagnosis:    { en: "Diagnosis", hi: "निदान" },
  sd_subj_map:     { en: "Subject strength map", hi: "विषय मज़बूती का नक़्शा" },
  sd_subj_sub:     { en: "Accuracy across subjects, averaged over all attempts.", hi: "सभी प्रयासों के औसत पर, हर विषय में सटीकता।" },
  sd_not_enough:   { en: "Not enough data yet", hi: "अभी इतने आँकड़े नहीं" },
  sd_benchmark:    { en: "Benchmark", hi: "तुलना" },
  sd_vs:           { en: "You vs batch vs topper", hi: "आप बनाम बैच बनाम टॉपर" },
  sd_ahead:        { en: "You're ahead of the pack", hi: "आप सबसे आगे हैं" },
  sd_ahead_d:      { en: "Nobody else has attempted your tests yet, so there is no honest comparison to draw.", hi: "आपके टेस्ट अभी किसी और ने नहीं दिए, इसलिए ईमानदार तुलना बनती ही नहीं।" },
  sd_subjwise:     { en: "Subject-wise", hi: "विषय-वार" },
  sd_bands:        { en: "Strong / Average / Weak", hi: "मज़बूत / औसत / कमज़ोर" },
  sd_bands_sub:    { en: "Each subject graded by your accuracy.", hi: "हर विषय आपकी सटीकता के आधार पर।" },
  sd_no_subj:      { en: "No subject data yet", hi: "अभी विषय के आँकड़े नहीं" },
  sd_timemgmt:     { en: "Time management", hi: "समय प्रबंधन" },
  sd_avg_time_q:   { en: "Avg time per question", hi: "हर सवाल पर औसत समय" },
  sd_trend_down:   { en: "Trending down means you're getting faster.", hi: "नीचे जाती रेखा का मतलब आप तेज़ हो रहे हैं।" },
  sd_action_plan:  { en: "Action plan", hi: "कार्य योजना" },
  sd_focus_next:   { en: "What to focus on next", hi: "अब किस पर ध्यान दें" },
  sd_plan_sub:     { en: "Built from your performance across all attempts.", hi: "आपके सभी प्रयासों के प्रदर्शन से बनी।" },
  sd_prio_subj:    { en: "Priority subjects", hi: "प्राथमिकता वाले विषय" },
  sd_momentum:     { en: "Momentum", hi: "रफ़्तार" },
  sd_weakest_d:    { en: "Your weakest areas are {x}. Spend the next study cycle revising concepts and drilling 25–30 previous-year questions in each before your next mock.",
                     hi: "आपके सबसे कमज़ोर विषय {x} हैं। अगले चक्र में इनके कॉन्सेप्ट दोहराइए और हर एक पर 25–30 पिछले साल के सवाल लगाइए, तभी अगला मॉक दीजिए।" },
  sd_no_weak:      { en: "No subject is in the weak band right now — hold the standard and add difficulty rather than volume.",
                     hi: "अभी कोई विषय कमज़ोर श्रेणी में नहीं है — यही स्तर बनाए रखिए और मात्रा नहीं, कठिनाई बढ़ाइए।" },
  sd_moved_d:      { en: "Your score moved from {x} to {y}{p}. Keep the test–revise–retest loop going.",
                     hi: "आपका स्कोर {x} से {y} हुआ{p}। टेस्ट–रिवीज़न–दोबारा टेस्ट का सिलसिला चलाते रहिए।" },
  sd_best_pct_is:  { en: " and your best percentile is {p}", hi: " और आपका सर्वश्रेष्ठ पर्सेंटाइल {p} है" },
  sd_one_point_d:  { en: "You've scored {x} so far. One attempt is a data point, not a trend — take two more and this turns into a real trajectory.", hi: "अब तक आपका स्कोर {x} है। एक प्रयास आँकड़ा है, रुझान नहीं — दो और दीजिए, तब असली दिशा बनेगी।" },
  sd_no_batch:     { en: "No batch enrollment yet", hi: "अभी किसी बैच में नामांकन नहीं" },
  sd_see_avail:    { en: "See available tests", hi: "उपलब्ध टेस्ट देखिए" },
  sd_renew:        { en: "Renew access", hi: "एक्सेस रिन्यू कीजिए" },
  sd_renew_msg:    { en: "This enrollment has expired — contact us to renew", hi: "यह नामांकन समाप्त हो गया — रिन्यू के लिए हमसे संपर्क कीजिए" },
  sd_all_done:     { en: "All done — review analytics", hi: "सब हो गया — विश्लेषण देखिए" },
  sd_continue:     { en: "Continue", hi: "जारी रखिए" },
  sd_search_mat:   { en: "Search materials or subject…", hi: "सामग्री या विषय खोजिए…" },
  sd_no_mat:       { en: "No study material yet", hi: "अभी कोई अध्ययन सामग्री नहीं" },
  sd_included:     { en: "Included in your plan", hi: "आपके प्लान में शामिल" },
  sd_board_empty:  { en: "The board is empty", hi: "बोर्ड अभी ख़ाली है" },
  sd_share:        { en: "Share", hi: "शेयर" },
  sd_share_rank:   { en: "Share your rank", hi: "अपनी रैंक शेयर कीजिए" },
  sd_top_perf:     { en: "Top performers", hi: "शीर्ष प्रदर्शन" },
  sd_ranked_by:    { en: "Ranked by average score across all attempts", hi: "सभी प्रयासों के औसत स्कोर के आधार पर" },
  sd_find_asp:     { en: "Find an aspirant…", hi: "किसी अभ्यर्थी को खोजिए…" },
  sd_your_link:    { en: "Your invite link", hi: "आपका इनवाइट लिंक" },
  sd_loading_dash: { en: "Loading your dashboard…", hi: "आपका डैशबोर्ड लोड हो रहा है…" },
  sd_signout:      { en: "Sign out", hi: "साइन आउट" },
  sd_student:      { en: "Student", hi: "छात्र" },
