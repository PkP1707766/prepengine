  ...
  sections: [
    {
      ...
      questions: Array.from({ length: 8 }, (_, i) => ({
        ...
        options: ["Article 14 — Equality before law", "Article 19 — Freedom of speech and expression", "Article 32 — Right to Constitutional Remedies", "Article 21 — Protection of life and personal liberty"],
        correct: i === 3 ? [0, 2] : 2,
        explanation: "Article 32 lets citizens move the Supreme Court directly to enforce Fundamental Rights.",
      })),
    },
    {
      ...
      questions: Array.from({ length: 4 }, (_, i) => ({
        ...
        options: i === 1 ? undefined : ["24 km/h", "30 km/h", "36 km/h", "45 km/h"],
        correct: i === 1 ? 36 : 2,
        tolerance: 0.01,
        explanation: "150 m ÷ 15 s = 10 m/s = 36 km/h.",
      })),
    },
  ],
};
